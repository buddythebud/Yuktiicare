      ...
      <main className="pt-24">
        <section className="container mx-auto px-4 py-12 md:py-20">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            >
              <p className="lead">
                Founded in 2018, YuktiCare emerged from a recognition of the significant barriers that differently-abled and elderly individuals face in accessing employment, housing, and community support.
              </p>
              ...
              <h2>Our Approach</h2>
              <p>
                YuktiCare takes a holistic approach to support, recognizing that employment, housing, and community engagement are interconnected needs. We work directly with individuals, employers, housing providers, and communities to create sustainable, inclusive solutions.
              </p>
