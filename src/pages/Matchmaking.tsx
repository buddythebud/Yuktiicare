          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-6">
                Indian Matrimony for Differently-Abled
              </h1>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                Our matrimony service is specially designed to connect differently-abled individuals across India for meaningful relationships and marriage.
              </p>
            </motion.div>
          </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Share your interests, preferences, and what you're looking for in a life partner.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-medium">Smart Matching System</h3>
                        <p className="text-muted-foreground">Our algorithm finds compatible matches based on your preferences, values, and lifestyle.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-medium">Secure Communications</h3>
                        <p className="text-muted-foreground">Connect through our platform's messaging system before deciding to meet in person.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">We provide resources for families and can help arrange initial meetings with potential matches.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
