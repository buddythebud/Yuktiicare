...
import DisabilityProfileForm from "@/components/jobs/DisabilityProfileForm";
import { 
  Pagination, 
  PaginationContent, 
  PaginationItem, 
      ...
      <main className="pt-24">
        <section className="section-container">
          <div className="max-w-3xl mx-auto mb-16">
            ...
            >
              <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center bg-gradient-to-r from-primary to-primary/70 text-transparent bg-clip-text">
                Find Your Perfect Career Match
              </h1>
              <p className="text-muted-foreground text-center mb-8 text-lg">
                Join our inclusive community where your abilities are valued. We're here to support your career journey every step of the way.
              </p>
            </motion.div>
          ...
          <div className="text-center mt-12 bg-secondary/30 p-6 rounded-xl border border-border max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button variant="outline" size="default">Upload Your Resume</Button>
              <Button variant="default" size="default">Schedule a Consultation</Button>
            </div>
          </div>
        </section>
      </main>
